...
class MembersActivity : BaseActivity() {
    ...
    fun memberAssignedSuccess(user: User){
        ...
        SendNotificationsToUserAsyncTask(mBoardDetails.name,user.fcmToken).execute()
    }

    private inner class SendNotificationsToUserAsyncTask(val boardName:String,val token:String):AsyncTask<Any,Void,String>(){
